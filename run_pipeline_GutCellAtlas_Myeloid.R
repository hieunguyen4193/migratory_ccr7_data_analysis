...
path.to.main.input <- file.path(path.to.storage, "FHager_datasets", "gutcellatlas", PROJECT)
...
stage_lst <- list(
  myeloid_raw_counts02_v2 = "gutcellatlas_myeloid"
)
